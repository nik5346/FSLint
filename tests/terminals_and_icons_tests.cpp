...
TEST_CASE("FMI 3.0 Terminals and Icons Validation", "[terminals][icons][fmi3]")
{
    ...
    SECTION("Failure Cases")
    {
        validate_fail("tests/data/fmi3/terminals_and_icons/fail/version_mismatch",
                      "fmiVersion in terminalsAndIcons.xml must match the modelDescription.xml fmiVersion");
        validate_fail("tests/data/fmi3/terminals_and_icons/fail/version_mismatch_301",
                      "fmiVersion in terminalsAndIcons.xml must match the modelDescription.xml fmiVersion");
