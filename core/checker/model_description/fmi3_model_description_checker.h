...
class Fmi3ModelDescriptionChecker : public ModelDescriptionCheckerBase
{
  protected:
    ...
    void checkGenerationDateReleaseYear(const std::string& dt, sys_seconds generation_time, TestResult& test) override;
  ...
  private:
    ...
    void checkDerivativeConsistency(const std::vector<Variable>& variables, Certificate& cert);
